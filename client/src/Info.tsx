    ...
    <>
      <div className='m-5'>
        ...
        <div className="mx-auto max-w-xl flex flex-row ">
          <input type="text" className="inline !border-r-0 !rounded-r-none " placeholder="Search" />
          <button className="flex items-center space-x-1 rounded-md rounded-l-none border border-l-0 border-gray-300 px-2.5 text-gray-700 hover:bg-gray-100">
