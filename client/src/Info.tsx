...
function Info() {
  ...
  return (
    <>
      ...
      <div className="mx-auto w-full max-w-xl flex flex-row ">
        <input type="text" className=" !border-r-0 !rounded-r-none ml-5" placeholder="Search Complaint" id="search" />
        <button onClick={search} className="flex items-center space-x-1 mr-5 rounded-md rounded-l-none border border-l-0 border-gray-300 px-2.5 text-gray-700 hover:bg-gray-100">
